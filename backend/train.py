...
def main():
    ...
    models_to_test = [
        ...
        {"name": "AdaBoost", "model": AdaBoostClassifier(algorithm='SAMME', random_state=42), "params": {"n_estimators": 100, "learning_rate": 1.0}},
    ...
    for m in models_to_test:
        if m["name"] in ["Random_Forest", "Logistic_Regression", "AdaBoost", "XGBoost"]:
