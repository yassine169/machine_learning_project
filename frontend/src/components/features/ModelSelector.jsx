...
const MODELS = [
    ...
    { id: 'ada', name: 'AdaBoost', desc: 'Ensemble adaptatif d\'arbres faibles, corrige les erreurs progressivement.' },
    { id: 'xgb', name: 'XGBoost', desc: 'Gradient boosting optimisé, très performant et scalable.' }
];
