...
const HYPER_PARAMS_SCHEMA = {
    ...
    'ada': [
        { name: 'Nombre d\'estimateurs (n_estimators)', id: 'n_estimators', type: 'number', default: 100, min: 10, step: 10 },
        { name: 'Taux d\'apprentissage (learning_rate)', id: 'learning_rate', type: 'number', default: 1.0, min: 0.1, step: 0.1 }
    ],
    'xgb': [
        { name: 'Nombre d\'estimateurs (n_estimators)', id: 'n_estimators', type: 'number', default: 100, min: 10, step: 10 },
        { name: 'Taux d\'apprentissage (learning_rate)', id: 'learning_rate', type: 'number', default: 0.1, min: 0.01, step: 0.01 },
        { name: 'Profondeur Max (max_depth)', id: 'max_depth', type: 'number', default: 5, min: 1, step: 1 }
    ]
};
